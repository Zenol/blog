...
Actualy, to make it works, I had to modify the `config.txt` file, as said by _Aptoitos_ on <http://www.designspark.com/knowledge/what-you-need-get-your-raspberry-pi-and-running> :
```
hdmi_drive=2
config_hdmi_boost=4
hdmi_group=1
